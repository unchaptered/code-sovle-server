...
@Injectable()
export default class UserProfileDetailValidationPipe implements PipeTransform {
    ...
    transform(value: any) {
        ...
        usernameValidated = (username.length >= 3 && username.length <= 20);
        ...
        if (!usernameValidated) message.push(`This ${username} format is not valid`);
